          ...
          <div id="layoutSidenav_content">
            <main>
              <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4 d-flex align-items-center gap-2">
                ...
                <div class="mt-5">
                  <div class="row">
                    <div class="col-md-6 col-12 mx-auto">
                      ...
                      <hr />
                      <form:form method="post" action="/admin/user/update" modelAttribute="user" class="row"
                        ...
                        <img src="/images/avatar/${user.avatar}" alt="" id="avatarPreview" class="img-responsive">
